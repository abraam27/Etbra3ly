...
<section class="page-header" data-stellar-background-ratio="1.2">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 text-center">
                    ...
                    <p class="page-breadcrumb">
                        <a href="AdminMessagesList.php">Home</a> / ADD Foundation
                    </p>
    ...
    if(isset($_POST['add'])){
        ...
        $foundation = new Organization($name, $address, $district, $city, $phone1, $phone2, $email, $username, $password, "Foundation", $logo, $logoTmp);
        if($foundation->addOrganization()){
            echo '<div class="container greenMessage">
                    <p>The Foundation has been Added Successfully <i class="fa fa-smile-o"></i> !</p>
                </div>';
        }else{
            echo '<div class="container redMessage">
                    <p>The Foundation is not Added <i class="fa fa-frown-o"></i> Please try Again !</p>
                </div>';
        }
    }
?>

        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="#">Home</a> / Foundations / <a href="AdminAddFoundation.php">Add Foundation</a>
                </p>
    ...
    if(isset($_GET['id'],$_GET['action'])){
        if(Organization::deleteOrganizationById($_GET['id'])){
            echo '<div class="container greenMessage">
                    <p>The Foundation has been Deleted Successfully <i class="fa fa-smile-o"></i> !</p>
                </div>';
        }else{
            echo '<div class="container redMessage">
                    <p>The Foundation is not Deleted <i class="fa fa-frown-o"></i> Please try Again !</p>
                </div>';
        }
    }
?>
...
<div class="well">
    ...
    <table class="table">
            ...
            <tbody>
                <?php
                    $foundations = Organization::retreiveAllOrganizations("Foundation");
                    if(is_array($foundations) && count($foundations)>0){
                        foreach ($foundations as $foundation) {
                            echo '<tr>
                                    <th scope="row"><a href="AdminFoundationDetails.php?id='.$foundation['organizationID'].'">'.$foundation['name'].'</a></th>
                                    <td>'.$foundation['district'].'</td>
                                    <td>'.$foundation['city'].'</td>
                                    <td>'.$foundation['phone1'].'</td>
                                    <td><a href="?action=delete&id='.$foundation['organizationID'].'">DELETE</a></td>
                                </tr>';
                        }
                    }
                ?>

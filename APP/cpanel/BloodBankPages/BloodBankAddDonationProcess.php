        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="BloodBankHome.php">Home</a> / Add Donation Process
                </p>
...
<?php
    if(isset($_POST['save'])){
        ...
        $bloodBag = new BloodBag($bloodGroup, $amount, $collectionDate, $expiryDate, $bloodBank['organizationID']);
        $donatedBloodBagID = $bloodBag->add();
        if(is_numeric($donatedBloodBagID)){
            $process = new Process($donorID, $bloodBank['organizationID'], $donatedBloodBagID, date("d-m-20y"), "Donation");

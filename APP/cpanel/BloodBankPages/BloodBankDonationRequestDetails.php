        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="BloodBankHome.php">Home</a> / <a href="BloodBankDonationRequestsList.php">Donation Requests List</a> / <a href="BloodbankAddDonationProcess.php?id=<?php echo $_GET['id']?>">Add Donation Process</a> / <a href="BloodBankDonationRequestsList.php?id=<?php echo $_GET['id']?>">Delete Donation Request</a>
                </p>
                        ...
                        <?php
                            if(isset($_GET['id'])){
                                ...
                                echo '<tr>
                                        ...
                                        <td><a href="loodBankDonorDetails.php?id='.$donor['donorID'].'">'.$donor['firstName'].' '.$donor['middleName'].' '.$donor['lastName'].'</a></td>
                                    </tr>
                                    <tr>

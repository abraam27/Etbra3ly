<?php
    ...
    if(isset ($_POST['edit'])){
        ...
        $updatedBloodBank = new Organization($name, $address, $district, $city, $phone1, $phone2, $email, $username, $password, "Blood Bank", $logo, $logoTmp, $_SESSION['organizationID']);
        if($updatedBloodBank->updateOrganiztionById()){
            $flag = 1;
        }else{
            $flag = 2;
        }
        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="BloodBankHome.php">Home</a> / Edit Profile
                </p>
                                                          ...
                                                          <ul class="form-section page-section">
                                                            ...
                                                            <li class="form-line jf-required" data-type="control_textbox" id="id_60">
                                                                  ...
                                                                  <div id="cid_60" class="form-input jf-required">
                                                                    <input type="text" id="input_60" name="name" data-type="input-textbox" class="form-textbox validate[required, Numeric]" size="20" value="'.$bloodBank['name'].'" data-component="textbox" required="" />
                                                                  </div>
                                                            </li>
                                                                    ...
                                                                    <table summary="" class="form-address-table" border="0" cellPadding="0" cellSpacing="0">
                                                                          <tbody>
                                                                            <tr>
                                                                                <td colSpan="2">
                                                                                  <span class="form-sub-label-container" style="vertical-align:top">
                                                                                    <input type="text" id="input_7_addr_line1" name="address" class="form-textbox validate[required] form-address-line" value="'.$bloodBank['address'].'" data-component="address_line_1" required="" />
                                                                            ...
                                                                            <tr>
                                                                                  <td width="50%">
                                                                                    <span class="form-sub-label-container" style="vertical-align:top">
                                                                                          <input type="text" id="input_63_city" name="district" class="form-textbox validate[required] form-address-city" size="21" value="'.$bloodBank['district'].'" data-component="city" required="" />
                                                                                  ...
                                                                                  <td>
                                                                                    <span class="form-sub-label-container" style="vertical-align:top">
                                                                                          <select class="form-dropdown validate[required] form-address-state" name="city" id="input_63_state" data-component="state" required="">
                                                                                            <option selected="" value="'.$bloodBank['city'].'"> '.$bloodBank['city'].' </option>
                                                            ...
                                                            <li class="form-line jf-required" data-type="control_textbox" id="id_64">
                                                                  ...
                                                                  <div id="cid_64" class="form-input jf-required">
                                                                    <input type="text" id="input_64" name="phone1" data-type="input-textbox" class="form-textbox validate[required, Numeric]" size="20" value="'.$bloodBank['phone1'].'" data-component="textbox" required="" />
                                                                  </div>
                                                            </li>
                                                            <li class="form-line jf-required" data-type="control_textbox" id="id_64">
                                                                  <label class="form-label form-label-left form-label-auto" id="label_64" for="input_64">
                                                                  ...
                                                                  <div id="cid_64" class="form-input jf-required">
                                                                    <input type="text" id="input_64" name="phone2" data-type="input-textbox" class="form-textbox validate[required, Numeric]" size="20" value="'.$bloodBank['phone2'].'" data-component="textbox" required="" />
                                                                  </div>
                                                            </li>
                                                            <li class="form-line jf-required" data-type="control_email" id="id_59">
                                                                  ...
                                                                  <div id="cid_59" class="form-input jf-required">
                                                                    <span class="form-sub-label-container" style="vertical-align:top">
                                                                          <input type="email" id="input_59" name="email" class="form-textbox validate[required, Email]" size="30" value="'.$bloodBank['email'].'" data-component="email" required="" />
                                                            ...
                                                            <li class="form-line jf-required" data-type="control_textbox" id="id_68">
                                                                  ...
                                                                  <div id="cid_68" class="form-input jf-required">
                                                                    <input type="text" id="input_68" name="username" data-type="input-textbox" class="form-textbox validate[required]" size="25" value="'.$bloodBank['username'].'" data-component="textbox" required="" />
                                                                  </div>
                                                            </li>
                                                            <li class="form-line jf-required" data-type="control_textbox" id="id_23">
                                                                  ...
                                                                  <div id="cid_23" class="form-input jf-required">
                                                                      <input type="password" id="input_23" name="password" data-type="input-textbox" class="form-textbox validate[required]" size="25" value="'.$bloodBank['password'].'" data-component="textbox" required="" />
                                                                  </div>
                                                            </li>

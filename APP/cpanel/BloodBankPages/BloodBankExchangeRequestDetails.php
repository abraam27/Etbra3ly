        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="BloodBankHome.php">Home</a> / <a href="BloodBankExchangeRequestsList.php">Exchange Requests List</a> / <a href="BloodbankAddExchangeProcess.php?id=<?php echo $_GET['id']?>">Add Exchange Process</a> / <a href="BloodBankExchangeRequestsList.php?id=<?php echo $_GET['id']?>">Delete Exchange Request</a>
                </p>
                        ...
                        <?php
                            if(isset($_GET['id'])){
                                ...
                                echo '<tr>
                                        ...
                                        <td><a href="BloodBankDonorDetails.php?id='.$donor['donorID'].'">'.$donor['firstName'].' '.$donor['middleName'].' '.$donor['lastName'].'</a></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <th scope="row">Exchange Date :</th>
                                        <td>'.$request['date'].'</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Needed Blood Group :</th>
                                        <td>'.$request['neededBloodGroup'].'</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Number of Bags :</th>
                                        <td>'.$request['numberOfBags'].' bags</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">Bags Size :</th>

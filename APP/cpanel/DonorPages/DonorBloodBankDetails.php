                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="page-breadcrumb">
                            <a href="DonorHome.php">Home</a> / <a href="DonorBloodBanksList.php">Blood Banks</a>
                        </p>
        ...
        <section>
                <div class="container">
                    <?php
                        if(isset($_GET['id'])){
                            $bloodBankID = $_GET['id'];
                            $bloodBank = Organization::retreiveOrganizationById($bloodBankID);
                            echo '<ul class="form-section page-section">
                                    <li id="cid_10" class="form-input-wide" data-type="control_head">
                                          <div class="form-header-group ">
                                            <div class="header-text httal htvam">
                                                  <h1 id="header_10" class="form-header" data-component="header">
                                                    <img src="../../upload/'.$bloodBank['logo'].'" width="200px" length="200px" style="border-radius: 5%;"/>  '.$bloodBank['name'].'
                                                  </h1>
                                            </div>
                                          </div>
                                    </li>
                                ...
                                <table class="table">
                                        ...
                                        <tbody>
                                                <tr>
                                                        ...
                                                        <td width="700px">'.$bloodBank['phone1'].'</td>
                                                </tr>
                                                <tr>
                                                        <th scope="row">Phone#2 : </th>
                                                        <td>'.$bloodBank['phone2'].'</td>
                                                </tr>
                                                <tr>

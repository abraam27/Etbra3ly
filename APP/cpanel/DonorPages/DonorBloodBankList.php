                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        ...
                        <p class="page-breadcrumb">
                            <a href="DonorHome.php">Home</a> / Blood Banks 
                        </p>
                                ...
                                <tbody>
                                    <?php
                                        if(isset($_GET['city']) && !is_numeric($_GET['city'])){
                                            $city = $_GET['city'];
                                            $bloodBanks = Organization::retreiveAllOrganizationsInCity("Blood Bank", $city);
                                            if(is_array($bloodBanks) && count($bloodBanks)>0 )
                                            {
                                                foreach ($bloodBanks as $bloodBank) {
                                                    echo '<tr>
                                                            <th scope="row"><a href="DonorBloodBankDetails.php?id='.$bloodBank['organizationID'].'">'.$bloodBank['name'].'</a></th>
                                                ...
                                                echo '<tr>
                                                        <td colspan="4" style="text-align:center" scope="row"> There is no Blood banks in '.$city.' !!!</td>
                                                    </tr>';
                                            }
                                        }else{
                                            ...
                                            if(is_array($bloodBanks) && count($bloodBanks)>0 )
                                            {
                                                ...
                                                echo '<tr>
                                                        <td colspan="4" style="text-align:center" scope="row"> There is no Blood banks !!!</td>
                                                    </tr>';
                                            }
                                        }
                                    ?>

...
<?php
    if(isset($_POST['register'])){
        ...
        if(is_null($photoName)){
            $donor = new Donor($SSN, $firstName, $middleName, $lastName, $dateOfBirth, $gender, $district, $city, $phoneNo, $email, $bloodGroup, "", $username, $password, $photo, $photoTmp);
            //print_r($donor);
            $donorID = $donor->addDonor();
            if(is_numeric($donorID)){
                $_SESSION["donorID"] = $donorID;
                header("location: DonorHome.php?message=success");
                exit();
            }else{
                echo '<div class="container redMessage">
                        <p>Your Registration is not Done <i class="fa fa-frown-o"></i> Please try Again !</p>
                    </div>';
            }
        }else{
            $donor = new Donor($SSN, $firstName, $middleName, $lastName, $dateOfBirth, $gender, $district, $city, $phoneNo, $email, $bloodGroup, "", $username, $password, $photo, $photoTmp);
                        ...
                        <ul class="form-section page-section">
                                ...
                                <div class="form-header-group ">
                                  <div class="header-text httal htvam">
                                        <h2 id="header_58" class="form-header" data-component="header">
                                          Be a blood Donor and Save lifes !
                                        </h2>
                                  </div>
                                </div>
                          </li>
                          <li class="form-line jf-required" data-type="control_textbox" id="id_60">
                                ...
                                <div id="cid_60" class="form-input jf-required">
                                  <input type="text" id="input_60" name="SSN" data-type="input-textbox" class="form-textbox validate[required, Numeric]" size="20" value="" data-component="textbox" required="" />
                                </div>
                          </li>
                                ...
                                <div id="cid_56" class="form-input jf-required">
                                  <div data-wrapper-react="true">
                                        <span class="form-sub-label-container" style="vertical-align:top">
                                          <input type="text" id="first_56" name="firstName" class="form-textbox validate[required]" size="10" value="" data-component="first" required="" />
                                          <label class="form-sub-label" for="first_56" id="sublabel_first" style="min-height:13px"> First Name </label>
                                        </span>
                                        <span class="form-sub-label-container" style="vertical-align:top">
                                          <input type="text" id="middle_56" name="middleName" class="form-textbox" size="10" value="" data-component="middle" required="" />
                                          <label class="form-sub-label" for="middle_56" id="sublabel_middle" style="min-height:13px"> Middle Name </label>
                                        </span>
                                        <span class="form-sub-label-container" style="vertical-align:top">
                                          <input type="text" id="last_56" name="lastName" class="form-textbox validate[required]" size="15" value="" data-component="last" required="" />
                                ...
                                <div id="cid_62" class="form-input jf-required">
                                  <div class="form-single-column" data-component="radio">
                                        <span class="form-radio-item" style="clear:left">
                                          ...
                                          <input type="radio" class="form-radio validate[required]" id="input_62_0" name="gender" value="Male" required="" />
                                          <label id="label_input_62_0" for="input_62_0"> Male </label>
                                        </span>
                                        <span class="form-radio-item" style="clear:left">
                                          <span class="dragger-item">
                                          </span>
                                          <input type="radio" class="form-radio validate[required]" id="input_62_1" name="gender" value="Female" required="" />
                                  ...
                                  <table summary="" class="form-address-table" border="0" cellPadding="0" cellSpacing="0">
                                        <tbody>
                                          <tr>
                                                <td width="50%">
                                                  <span class="form-sub-label-container" style="vertical-align:top">
                                                        <input type="text" id="input_63_city" name="district" class="form-textbox validate[required] form-address-city" size="21" value="" data-component="city" required="" />
                          ...
                          <li class="form-line jf-required" data-type="control_textbox" id="id_64">
                                ...
                                <div id="cid_64" class="form-input jf-required">
                                  <input type="text" id="input_64" name="phoneNo" data-type="input-textbox" class="form-textbox validate[required, Numeric]" size="20" value="" data-component="textbox" required="" />
                                </div>
                          </li>
                          <li class="form-line jf-required" data-type="control_email" id="id_59">
                                ...
                                <div id="cid_59" class="form-input jf-required">
                                  <span class="form-sub-label-container" style="vertical-align:top">
                                        <input type="email" id="input_59" name="email" class="form-textbox validate[required, Email]" size="30" value="" data-component="email" required="" />
                          ...
                          <li class="form-line jf-required" data-type="control_textbox" id="id_68">
                                ...
                                <div id="cid_68" class="form-input jf-required">
                                  <input type="text" id="input_68" name="username" data-type="input-textbox" class="form-textbox validate[required]" size="25" value="" data-component="textbox" required="" />
                                </div>
                          </li>
                          <li class="form-line jf-required" data-type="control_textbox" id="id_23">
                                ...
                                <div id="cid_23" class="form-input jf-required">
                                    <input type="password" id="input_23" name="password" data-type="input-textbox" class="form-textbox validate[required]" size="25" value="" data-component="textbox" required="" />
                                </div>
                          </li>
                                ...
                                <div id="cid_69" class="form-input">
                                  <div data-wrapper-react="true">
                                        <div data-wrapper-react="true">
                                          ...
                                          <input type="file" id="input_69" name="photo"  class="form-upload-multiple" data-imagevalidate="yes" data-file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" data-file-maxsize="10854" data-file-minsize="0" data-file-limit="" data-component="fileupload" />
                                        </div>
                                  </div>
                                </div>
                          </li>
                          <li class="form-line" data-type="control_button" id="id_57">
                                <div id="cid_57" class="form-input-wide">
                                  <div style="text-align:center" class="form-buttons-wrapper">
                                      <button id="input_57" type="submit" class="form-submit-button" data-component="button" name="register" value="register">
                                          Register
                                        </button>
                                  </div>
                                </div>

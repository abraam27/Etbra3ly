        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="HospitalHome.php">Home</a> / Blood Bags / <a href="HospitalAddBloodBag.php">Add Blood Bag</a>
                </p>
                        ...
                        <tbody>
                            <?php
                                ...
                                if(isset($_GET['bloodGroup']) && !is_numeric($_GET['bloodGroup'])){
                                    ...
                                    $bloodBags = BloodBag::retrieveAllBloodBagsOfOrganizationByGroup($hospital['organizationID'], $bloodGroup);
                                    ...
                                    $bloodBags = BloodBag::retrieveAllBloodBagsOfOrganization($hospital['organizationID']);
                                    if(is_array($bloodBags) && count($bloodBags) > 0){
                                        foreach ($bloodBags as $bloodBag) {
                                            $bloodBagID = $bloodBag['bloodBagID'];
                                            echo '

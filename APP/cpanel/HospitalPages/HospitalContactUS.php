        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="HospitalHome.php">Home</a> / Contact US
                </p>
                ...
                <div class="contact-form-block">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" >
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" id="user_name" name="name" value="<?php echo $hospital['name'];?>" placeholder="Name" data-msg="Please Write Your Name" />
                        </div>

                        <div class="form-group">
                            <input type="email" class="form-control" id="user_email" name="email" value="<?php echo $hospital['email'];?>" placeholder="Email" data-msg="Please Write Your Valid Email" />
                        </div>
                        <div class="form-group">

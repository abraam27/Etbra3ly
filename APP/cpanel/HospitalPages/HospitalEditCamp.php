        ...
        <div class="row">
            ...
            <div class="col-sm-12 text-center">
                ...
                <p class="page-breadcrumb">
                    <a href="HospitalHome.php">Home</a> / Edit Camp / <a href="HospitalCampDetails.php?id=<?php echo $_GET['id'] ?>">Camp Details</a>
                </p>
...
<?php
    if(isset($_POST['edit'])){
        ...
        $date = $ndate . '-' . $nmonth . '-' . $nyear;
        $time = $nhour . ':' . $nmin . ' ' . $nampm;
        $imageName = $_FILES['image']['name'];
        $imageTmp = $_FILES['image']['tmp_name'];
        $updatedCamp = new Camp($name, $address, $district, $city, $date, $time, $moreDetails, $hospital['organizationID'], $campID);
        if($updatedCamp->update()){
            echo '<div class="container greenMessage">
                    <p>The Camp has been Updated Successfully <i class="fa fa-smile-o"></i> !</p>
		</div>';
            for($index = 0; $index<count($imageTmp); $index++){
                        $gallery = new Gallery($campID, $imageName[$index], $imageTmp[$index]);
                        $gallery->addImageToCamp();
                    }
        } else {
            echo '<div class="container redMessage">
                    <p>The camp is not Updated <i class="fa fa-frown-o"></i> Please try Again !</p>
		</div>';
        }
    }
?>
<?php
    ...
    if(isset($_GET['action'])){
        ...
        switch ($action){
            case 'delete':
                if(Gallery::deleteImageCamp($campID, $imageName)){
                    $flag = 1;
                }else{
                    $flag = 2;
                }
...
<section>
        <div class="container">
            <?php
                ...
                echo '<form class="jotform-form" action="'.$_SERVER['PHP_SELF'].'?id='.$campID.'" method="POST" enctype="multipart/form-data">
                              ...
                              <ul class="form-section page-section">
                                ...
                                <li class="form-line jf-required" data-type="control_textbox" id="id_20">
                                      ...
                                      <div id="cid_20" class="form-input jf-required">
                                        <input type="text" id="input_20" name="name" data-type="input-textbox" class="form-textbox validate[required]" size="40" value="'.$camp['name'].'" data-component="textbox" required="" />
                                      </div>
                                </li>
                                        ...
                                        <table summary="" class="form-address-table" border="0" cellPadding="0" cellSpacing="0">
                                              <tbody>
                                                <tr>
                                                      <td colSpan="2">
                                                        <span class="form-sub-label-container" style="vertical-align:top">
                                                              <input type="text" id="input_17_addr_line1" name="address" class="form-textbox validate[required] form-address-line" value="'.$camp['address'].'" data-component="address_line_1" required="" />
                                                ...
                                                <tr>
                                                      <td width="50%">
                                                        <span class="form-sub-label-container" style="vertical-align:top">
                                                              <input type="text" id="input_17_city" name="district" class="form-textbox validate[required] form-address-city" size="21" value="'.$camp['district'].'" data-component="city" required="" />
                                                              <label class="form-sub-label" for="input_17_city" id="sublabel_17_city" style="min-height:13px"> District </label>
                                                        </span>
                                                      </td>
                                                      <td>
                                                        <span class="form-sub-label-container" style="vertical-align:top">
                                                              <select class="form-dropdown validate[required] form-address-state" name="city" id="input_17_state" data-component="state" required="">
                                                                <option selected="" value="'.$camp['city'].'"> '.$camp['city'].' </option>
                                                ...
                                                <tr>
                                                      <td width="50%" style="display:none">
                                                        <span class="form-sub-label-container" style="vertical-align:top">
                                                              <input type="text" id="input_17_postal" name="q17_address[postal]" class="form-textbox validate[required] form-address-postal" size="10" value="" data-component="zip" required="" />
                                                              <label class="form-sub-label" for="input_17_postal" id="sublabel_17_postal" style="min-height:13px"> Zip Code </label>
                                                        </span>
                                                      </td>
                                                      <td style="display:none">
                                                        <span class="form-sub-label-container" style="vertical-align:top">
                                                              <select class="form-dropdown validate[required] form-address-country" name="q17_address[country]" id="input_17_country" data-component="country" required="">
                                      ...
                                      <div id="cid_13" class="form-input jf-required">
                                        <div data-wrapper-react="true">
                                              <div style="display:none">
                                                <span class="form-sub-label-container" style="vertical-align:top">
                                                      <input type="tel" class="form-textbox validate[required, limitDate]" id="day_13" name="day" size="2" data-maxlength="2" value="'.$day.'" required="" />
                                                ...
                                                <span class="form-sub-label-container" style="vertical-align:top">
                                                      <input type="tel" class="form-textbox validate[required, limitDate]" id="month_13" name="month" size="2" data-maxlength="2" value="'.$month.'" required="" />
                                                      <span class="date-separate">
                                                         /
                                                      </span>
                                                ...
                                                <span class="form-sub-label-container" style="vertical-align:top">
                                                      <input type="tel" class="form-textbox validate[required, limitDate]" id="year_13" name="year" size="4" data-maxlength="4" value="'.$year.'" required="" />
                                                      <label class="form-sub-label" for="year_13" id="sublabel_year" style="min-height:13px"> Year </label>
                                                </span>
                                              </div>
                                              <span class="form-sub-label-container" style="vertical-align:top">
                                                <input type="text" class="form-textbox validate[required, limitDate, validateLiteDate]" id="lite_mode_13" size="12" data-maxlength="12" data-age="" value="'.$day.'-'.$month.'-'.$year.'" required="" data-format="ddmmyyyy" data-seperator="/" placeholder="dd/mm/yyyy" />
                                              ...
                                              <span style="white-space:nowrap;display:inline-block" class="allowTime-container">
                                                ...
                                                <span class="form-sub-label-container" style="vertical-align:top">
                                                      <select class="time-dropdown form-dropdown validate[required, limitDate]" id="ampm_13" name="ampm">
                                                        <option selected="" value="'.$ampm.'"> '.$ampm.' </option>
                                ...
                                <li class="form-line" data-type="control_textarea" id="id_9">
                                      ...
                                      <div id="cid_9" class="form-input">
                                        <textarea id="input_9" class="form-textarea" name="moreDetails" cols="40" rows="6" data-component="textarea" value="">'.$camp['moreDetails'].'</textarea>
                                      </div>
                                </li>
                                <li class="form-line" data-type="control_fileupload" id="id_21">
                                      <label class="form-label form-label-left form-label-auto" id="label_21" for="input_21"> Camp Photos </label>
                                      <div id="cid_21" class="form-input">
                                        <div data-wrapper-react="true">
                                              <div data-wrapper-react="true">
                                                ...
                                                <input type="file" id="input_21" name="image[]" multiple="multiple" data-imagevalidate="yes" data-file-accept="jpg, jpeg, png, gif"  />
                                              </div>
                                        </div>
                                      </div>
                                </li>
                          ...
                          <div class="form-header-group ">
                            <div class="header-text httal htvam">
                                <h1 id="header_10" class="form-header" data-component="header">
                                    Camp Photos ( Click on Photo to Delete ) | <a href="?action=deleteAll&id=<?php echo $campID;?>">DELETE ALL IMAGES</a>
                                </h1>
                            </div>
                          </div>
                    </li>
                ...
                <?php
                    if($flag == 1){
                        echo '<div class="container greenMessage">
                            <p>The Photo has been Deleted Successfully <i class="fa fa-smile-o"></i> !</p>
                        </div>';
                    }elseif($flag == 2){
                        echo '<div class="container redMessage">
                                <p>The Photo is not Deleted <i class="fa fa-frown-o"></i> Please try Again !</p>
                            </div>';
                    }elseif($flag == 3){
                        echo '<div class="container greenMessage">
                            <p>The Photos have been Deleted Successfully <i class="fa fa-smile-o"></i> !</p>
                        </div>';
                    }elseif($flag == 4){
                        echo '<div class="container redMessage">
                            <p>The Photos are not Deleted <i class="fa fa-frown-o"></i> Please try Again !</p>
                        </div>';
                    }
                    $campImages = Gallery::retreiveAllImagesByIdCamp($campID);
                    if(is_array($campImages) && count($campImages)>0){
                    
                        echo '<div class="container-fluid wow fadeInUp">
                                <div class="row no-padding-gallery">';
                        foreach ($campImages as $image) {
                            echo '<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 gallery-container">
                                    <a data-gall="myGallery" href="?action=delete&id='.$campID.'&imageName='.$image.'">
                                        <figure >
                                            <img src="../../upload/'.$image.'" alt="gallery image" width="370px" height="350px" />
